...
func TestDiskIOStats(t *testing.T) {
	...
	expectedFieldsService = map[string]any{
		"pod_diskio_io_service_bytes_write": float64(10000),
		"pod_diskio_io_service_bytes_total": float64(10010),
		"pod_diskio_io_service_bytes_async": float64(10000),
		"pod_diskio_io_service_bytes_sync":  float64(10000),
		"pod_diskio_io_service_bytes_read":  float64(10),
	}
	expectedFieldsServiced = map[string]any{
		"pod_diskio_io_serviced_async": float64(10),
		"pod_diskio_io_serviced_sync":  float64(10),
		"pod_diskio_io_serviced_read":  float64(10),
		"pod_diskio_io_serviced_write": float64(10),
		"pod_diskio_io_serviced_total": float64(20),
	}
	expectedTags = map[string]string{
		"device": "/dev/xvda",
		"Type":   "PodDiskIO",
